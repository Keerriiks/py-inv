...
def make_parser():
    ...
    parser.add_argument(
        "--frames=", dest="frames", type=list, default=['1', '0', '0', ',', '1', '5', '0', ',', '2', '0', '0']
    )
    ...
    parser.add_argument(
        "--path", "-i", dest="i", default="./assets/dog.jpg", help="path to images or video"
    )
...
def main(exp, args):
    ...
    if args.demo == "image":
        ...
        if not os.path.exists('./frames_raw'):
            os.system('mkdir ./frames_raw')
...
if __name__ == "__main__":
    ...
    frames = "".join(args.frames)
    frame_list = frames.split(',')
    args.frames = frame_list
    print(args)
